...
const arrText = {
    ...
    1: {
        task: 'А теперь введи код от домофона твоей предыдущей квартиры=)',
    ...
    7: {
        task: "Между Кунцевщиной и Спортивной видели сохатых, тебе нужно найти это место и хорошенько там осмотреться. В ответ нужно записать номер телефона, который там найдешь))",
    ...
    10: {
        ...
        modalText: "CУПЕР!!! Подарок у тебя)))"
    }
